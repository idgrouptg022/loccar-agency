...
import { Button, CircularProgress, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Grid, List, ListItemButton, ListItemIcon, ListItemText, Typography } from '@mui/material'
import axios from 'axios'
import React, { Fragment, useState } from 'react'
import { useNavigate } from 'react-router-dom'

export default function OutdateDriverLicence(props) {
    ...
    async function fetData() {
        await axios({
            method: "get",
            url: `${process.env.REACT_APP_API_URL}/outdates/driver-licenses/list`,
            headers: {
    ...
    return (
        <Fragment>
            <br /><br />
            <h2>Permis de conduire</h2><br /><br />
            {
